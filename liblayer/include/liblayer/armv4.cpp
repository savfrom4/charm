...
inline void ExecutionState::arm_add(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_add: before r" << static_cast<int>(rd) << "=" << r[rd] << ", r"
  ...
  LAYER_LOG("arm_add: after r" << static_cast<int>(rd) << "=" << r[rd]);
}

inline void ExecutionState::arm_adc(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_adc: before r" << static_cast<int>(rd) << "=" << r[rd] << ", r"
                                << static_cast<int>(rn) << "=" << r[rn]
                                << ", imm=" << imm << ", cs=" << cs);
  ...
  LAYER_LOG("arm_adc: after r" << static_cast<int>(rd) << "=" << r[rd]);
}

inline void ExecutionState::arm_sub(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_sub: before r" << static_cast<int>(rd) << "=" << r[rd] << ", r"
                                << static_cast<int>(rn) << "=" << r[rn]
                                << ", imm=" << imm);
  ...
  LAYER_LOG("arm_sub: after r" << static_cast<int>(rd) << "=" << r[rd]);
}

inline void ExecutionState::arm_sbc(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_sbc: before r" << static_cast<int>(rd) << "=" << r[rd] << ", r"
                                << static_cast<int>(rn) << "=" << r[rn]
                                << ", imm=" << imm << ", cs=" << cs);
  ...
  LAYER_LOG("arm_sbc: after r" << static_cast<int>(rd) << "=" << r[rd]);
}

inline void ExecutionState::arm_cmp(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_cmp: before r" << static_cast<int>(rn) << "=" << r[rn]
                                << ", imm=" << imm);
  ...
  LAYER_LOG("arm_cmp: result=" << result << " (flags: N=" << mi << ", Z=" << z
                               << ", C=" << cs << ", V=" << vs << ")");
}

inline void ExecutionState::arm_mov(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_mov: before r" << static_cast<int>(rd) << "=" << r[rd]
                                << ", imm=" << imm);
  ...
  LAYER_LOG("arm_mov: after r" << static_cast<int>(rd) << "=" << r[rd]);
}

inline void ExecutionState::arm_rsb(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_rsb: before r" << static_cast<int>(rd) << "=" << r[rd] << ", r"
                                << static_cast<int>(rn) << "=" << r[rn]
                                << ", imm=" << imm);
  ...
  LAYER_LOG("arm_rsb: after r" << static_cast<int>(rd) << "=" << r[rd]);
}

inline void ExecutionState::arm_rsc(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_rsc: before r" << static_cast<int>(rd) << "=" << r[rd] << ", r"
                                << static_cast<int>(rn) << "=" << r[rn]
                                << ", imm=" << imm << ", cs=" << cs);
  ...
  LAYER_LOG("arm_rsc: after r" << static_cast<int>(rd) << "=" << r[rd]);
}

inline void ExecutionState::arm_and(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_and: before r" << static_cast<int>(rd) << "=" << r[rd] << ", r"
                                << static_cast<int>(rn) << "=" << r[rn]
                                << ", imm=" << imm);
  r[rd] = r[rn] & imm;
  ...
  LAYER_LOG("arm_and: after r" << static_cast<int>(rd) << "=" << r[rd]);
}

inline void ExecutionState::arm_eor(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_eor: before r" << static_cast<int>(rd) << "=" << r[rd] << ", r"
                                << static_cast<int>(rn) << "=" << r[rn]
                                << ", imm=" << imm);
  r[rd] = r[rn] ^ imm;
  ...
  LAYER_LOG("arm_eor: after r" << static_cast<int>(rd) << "=" << r[rd]);
}

inline void ExecutionState::arm_orr(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_orr: before r" << static_cast<int>(rd) << "=" << r[rd] << ", r"
                                << static_cast<int>(rn) << "=" << r[rn]
                                << ", imm=" << imm);
  r[rd] = r[rn] | imm;
  if (s) {
  ...
  LAYER_LOG("arm_orr: after r" << static_cast<int>(rd) << "=" << r[rd]);
}

inline void ExecutionState::arm_bic(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_bic: before r" << static_cast<int>(rd) << "=" << r[rd] << ", r"
                                << static_cast<int>(rn) << "=" << r[rn]
                                << ", imm=" << imm);
  r[rd] = r[rn] & ~imm;
  ...
  LAYER_LOG("arm_bic: after r" << static_cast<int>(rd) << "=" << r[rd]);
}

inline void ExecutionState::arm_mvn(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_mvn: before r" << static_cast<int>(rd) << "=" << r[rd]
                                << ", imm=" << imm);
  r[rd] = ~imm;
  ...
  LAYER_LOG("arm_mvn: after r" << static_cast<int>(rd) << "=" << r[rd]);
}

inline void ExecutionState::arm_tst(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_tst: before r" << static_cast<int>(rn) << "=" << r[rn]
                                << ", imm=" << imm);
  ...
  LAYER_LOG("arm_tst: result=" << result << " (flags: N=" << mi << ", Z=" << z
                               << ")");
}

inline void ExecutionState::arm_teq(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_teq: before r" << static_cast<int>(rn) << "=" << r[rn]
                                << ", imm=" << imm);
  ...
  LAYER_LOG("arm_teq: result=" << result << " (flags: N=" << mi << ", Z=" << z
                               << ")");
}

inline void ExecutionState::arm_cmn(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_value_t imm) {
  LAYER_LOG("arm_cmn: before r" << static_cast<int>(rn) << "=" << r[rn]
                                << ", imm=" << imm);
  reg_value_t result;
  ...
  LAYER_LOG("arm_cmn: result=" << result << " (flags: N=" << mi << ", Z=" << z
                               << ", C=" << cs << ", V=" << vs << ")");
}

inline void ExecutionState::arm_mul(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_idx_t rs, reg_idx_t rm) {
  LAYER_LOG("arm_mul: before r" << static_cast<int>(rd) << "=" << r[rd] << ", r"
  ...
  LAYER_LOG("arm_mul: after r" << static_cast<int>(rd) << "=" << r[rd]);
}

inline void ExecutionState::arm_mla(bool s, reg_idx_t rd, reg_idx_t rn,
                                    reg_idx_t rs, reg_idx_t rm) {
  LAYER_LOG("arm_mla: before r" << static_cast<int>(rd) << "=" << r[rd] << ", r"
                                << static_cast<int>(rm) << "=" << r[rm] << ", r"
  ...
  LAYER_LOG("arm_mla: after r" << static_cast<int>(rd) << "=" << r[rd]);
}

inline void ExecutionState::arm_mull(bool s, bool sign, reg_idx_t rd_lo,
                                     reg_idx_t rd_hi, reg_idx_t rm,
                                     reg_idx_t rs) {
  LAYER_LOG("arm_mull: before r" << static_cast<int>(rd_lo) << "=" << r[rd_lo]
  ...
  LAYER_LOG("arm_mull: result=" << result << " (r" << static_cast<int>(rd_lo)
                                << "=" << std::hex << r[rd_lo] << ", r"
...
inline void ExecutionState::arm_mlal(bool s, bool sign, reg_idx_t rd_lo,
                                     reg_idx_t rd_hi, reg_idx_t rm,
                                     reg_idx_t rs) {
  LAYER_LOG("arm_mlal: before r" << static_cast<int>(rd_lo) << "=" << r[rd_lo]
                                 << ", r" << static_cast<int>(rd_hi) << "="
                                 << r[rd_hi] << ", r" << static_cast<int>(rm)
                                 << "=" << r[rm] << ", r"
                                 << static_cast<int>(rs) << "=" << r[rs]);
...
inline void ExecutionState::arm_ldr(bool pre_indx, bool add, bool byte,
  ...
  LAYER_LOG("arm_ldr: r" << static_cast<int>(rd) << ", r"
  ...
  if (copy) {
    const void *mem = reinterpret_cast<const void *>(memory_resolve(addr));
    ...
    LAYER_LOG("arm_ldr: read value=0x" << std::hex << r[rd] << std::dec);
  }
  ...
  if (write_back || !pre_indx) {
    ...
    LAYER_LOG("arm_ldr: write back to r" << static_cast<int>(rn) << "=0x"
...
inline void ExecutionState::arm_str(bool pre_indx, bool add, bool byte,
  ...
  LAYER_LOG("arm_str: r" << static_cast<int>(rd) << ", r"
                         << static_cast<int>(rn) << ", offset=0x" << offset
                         << ", pre_indx=0x" << pre_indx << ", add=0x" << add
                         << ", byte=0x" << byte << ", write_back=0x"
                         << write_back << ", addr=0x" << std::hex << addr
  ...
  if (copy) {
    void *mem = reinterpret_cast<void *>(memory_resolve(addr));
    ...
    if (byte) {
      ...
      LAYER_LOG("arm_str: wrote value=0x"
                << std::hex << (static_cast<uint8_t>(value)) << ", addr=0x"
                << addr << std::dec);
    } else {
      memcpy(mem, &value, sizeof(uint32_t));
      LAYER_LOG("arm_str: wrote value=0x" << std::hex << value << ", addr=0x"
                                          << addr << std::dec);
    }
  }
  ...
  if (write_back || !pre_indx) {
    ...
    r[rn] = base + (add ? offset : -offset);
    LAYER_LOG("arm_str: write back to r" << static_cast<int>(rn) << "=0x"
                                         << std::hex << r[rn] << std::dec);
  }
}
...
inline void ExecutionState::arm_ldrh(bool pre_indx, bool add, bool write_back,
  ...
  LAYER_LOG("arm_ldrh: r" << static_cast<int>(rn) << ", r"
                          << static_cast<int>(rd) << ", offset=0x" << offset
                          << ", type=0x" << static_cast<int>(type)
                          << ", addr=0x" << std::hex << addr << std::dec);

  const char *mem = reinterpret_cast<const char *>(memory_resolve(addr));
  ...
  case 0b01: // LDRHR
    ...
    LAYER_LOG("arm_ldrh: read halfword value=0x"
  ...
  case 0b10: // LDRSBR
    ...
    LAYER_LOG("arm_ldrh: read signed byte value=0x"
  ...
  case 0b11: // LDRSHR
    ...
    LAYER_LOG("arm_ldrh: read signed halfword value=0x"
  ...
  if (write_back || !pre_indx) {
    ...
    r[rn] = base + (add ? offset : -offset);
    LAYER_LOG("arm_ldrh: write back to r" << static_cast<int>(rn) << "=0x"
                                          << std::hex << r[rn] << std::dec);
  }
}
...
inline void ExecutionState::arm_strh(bool pre_indx, bool add, bool write_back,
  ...
  LAYER_LOG("arm_strh: r" << static_cast<int>(rn) << ", r"
                          << static_cast<int>(rd) << ", offset=0x" << offset
                          << ", type=0x" << static_cast<int>(type)
                          << ", addr=0x" << std::hex << addr << std::dec);

  char *mem = reinterpret_cast<char *>(memory_resolve(addr));
  ...
  case 0b01: // STRHR
    ...
    LAYER_LOG("arm_strh: wrote halfword value=0x"
  ...
  case 0b10: // STRSBR
    ...
    LAYER_LOG("arm_strh: wrote byte value=0x"
  ...
  if (write_back || !pre_indx) {
    ...
    r[rn] = base + (add ? offset : -offset);
    LAYER_LOG("arm_strh: write back to r" << static_cast<int>(rn) << "=0x"
                                          << std::hex << r[rn] << std::dec);
  }
}
...
inline void ExecutionState::arm_ldm(bool pre_indx, bool add, bool write_back,
  ...
  LAYER_LOG("arm_ldm: r" << static_cast<int>(rn) << ", reg_list=0x" << std::hex
  ...
  if (write_back) {
    ...
    LAYER_LOG("arm_ldm: write back to r" << static_cast<int>(rn) << "=0x"
                                         << std::hex << r[rn] << std::dec);
  }
  ...
  if (copy) {
    ...
    for (reg_value_t i = 0; i < REG_COUNT; i++) {
      ...
      LAYER_LOG("arm_ldm: read r" << static_cast<int>(i) << "=0x" << std::hex
                                  << r[i] << ", addr=0x" << std::hex
...
inline void ExecutionState::arm_stm(bool pre_indx, bool add, bool write_back,
  ...
  LAYER_LOG("arm_stm: r" << static_cast<int>(rn) << ", reg_list=0x" << std::hex
                         << reg_list << ", pre_indx=0x" << pre_indx
                         << ", add=0x" << add << ", write_back=0x" << write_back
                         << ", base=0x" << base << ", starting addr=0x" << addr
                         << std::dec);
  ...
  if (copy) {
    ...
    for (reg_value_t i = 0; i < REG_COUNT; i++) {
      ...
      LAYER_LOG("arm_stm: wrote r" << static_cast<int>(i) << "=0x" << std::hex
                                   << r[i] << ", addr=0x" << std::hex
                                   << reinterpret_cast<uintptr_t>(mem)
                                   << std::dec);
      mem += 4;
      ...
      // We write-back now
      r[rn] = add ? base + n * 4 : base - n * 4;
      LAYER_LOG("arm_stm: write back (n = " << n << ") to r"
